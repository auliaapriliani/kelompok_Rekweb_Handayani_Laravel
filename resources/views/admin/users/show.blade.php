            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th> Alamat  </th>
                            <td field-key='role'>{{ $user->alamat }}</td>
                        </tr>

                        <tr>
                            <th> Tanggal Lahir  </th>
                            <td field-key='role'>{{ $user->tgl_lahir }}  </td>
                        </tr>

                        <tr>
                            <th> Jamkesnas  </th>
                            <td field-key='role'>{{ $user->jamkesnas }}</td>
                        </tr>

                        <tr>
                            <th> Usia Kehamilan  </th>
                            <td field-key='role'>{{ $user->usia_kehamilan }} Bulan</td>
                        </tr>

                        <tr>
                            <th> Trimester Ke  </th>
                            <td field-key='role'>{{ $user->trimester_ke }} </td>
                        </tr>
